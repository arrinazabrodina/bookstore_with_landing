...
namespace BookStoreWebApplication.Controllers
{
    public class BuyersController : Controller
    {
        ...
        public BuyersController(DbbookStoreContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PhoneNumber,Address,Email,BirthDate")] Buyer buyer)
        {
            if (id != buyer.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbbookStoreContext.Buyers'  is null.");
            }
            var buyer = await _context.Buyers.FindAsync(id);
            if (buyer != null)
            {
